...
const query=searchParams.get("category");
  ...
  const searchProduct=products.filter(product=>product.category.toLocaleLowerCase().includes(query.toLocaleLowerCase()))
  
  return NextResponse.json({ message: "Searching the Products", success: true,searchProduct });
}
